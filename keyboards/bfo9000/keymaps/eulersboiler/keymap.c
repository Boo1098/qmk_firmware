...
[_BASE] = LAYOUT( \
    KC_ESC,  KC_NLCK, KC_CALC, KC_BSPC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  DYN_REC_START1, \
    ...
    KC_P0,   XXXXXXX, KC_PDOT, KC_ENT,  KC_LCTL, KC_LALT, KC_LWIN, KC_SPC,  KC_SPC,        KC_SPC,  KC_SPC,  KC_RALT, KC_RWIN, KC_RCTL, DYN_MACRO_PLAY1, KC_LEFT, KC_DOWN, KC_RGHT \
)
...
bool process_record_user(uint16_t keycode, keyrecord_t *record){
	uint16_t macro_kc = (keycode == MO(_BASE) ? DYN_REC_STOP : keycode);
